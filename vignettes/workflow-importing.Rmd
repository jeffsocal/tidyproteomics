...
# import the data
data_prot <- "~/Local/gitdata/tidyproteomics_data/ProteomeDiscoverer_2.5/p97KD_HCT116_proteins.xlsx" %>% import('ProteomeDiscoverer', 'proteins')
...
# import the data
data_prot <- "~/Local/gitdata/tidyproteomics_data/MaxQuant_1.6.10.43/proteinGroups.txt" %>% import('MaxQuant', 'proteins')
...
# import the data
data_prot <- "~/Local/gitdata/tidyproteomics_data/FragPipe_19.1/combined_protein.tsv" %>% import('FragPipe', 'proteins')
