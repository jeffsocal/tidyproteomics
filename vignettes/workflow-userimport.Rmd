...
Note that DEqMS is _".. takes into account the inherent dependence of protein variance on the num- ber of PSMs or peptides used for quantification, thereby pro- viding a more accurate variance estimation."_ and as such PSM count need to be be integrated into this analysis, following the protocol outlined in the documentation. The purpose of this vignette is not to replicate the DEqMS method, rather to demonstrate how one would build an import definition file to utilize tidyproteomics.
