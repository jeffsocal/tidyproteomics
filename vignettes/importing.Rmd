...
The currently known and not directly supported quantitative proteomics platforms are [Spectronaut](https://biognosys.com/software/spectronaut/) and [Proteograph Analysis Suite](https://seer.bio/products/proteograph-analysis-suite/). Given a flat-file export, data from these platforms could also be importable.
