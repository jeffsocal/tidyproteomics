...
|------------------|-------------------|------------------|------------------|
| [ProteomeDiscoverer](https://www.thermofisher.com/us/en/home/industrial/mass-spectrometry/liquid-chromatography-mass-spectrometry-lc-ms/lc-ms-software/multi-omics-data-analysis/proteome-discoverer-software.html) | \*.xlsx *peptides export*       | \*.xlsx *proteins export* | requires layout configuration |
| [MaxQuant](https://www.maxquant.org/)                                                                                                                                                                               | evidence.txt                    | proteinGroups.txt         |                               |
| [Skyline](https://skyline.ms/project/home/software/skyline/begin.view)                                                                                                                                              | \*.csv *MSstats peptide report* |                           | requires MSstats install      |
| [DIA-NN](https://github.com/vdemichev/DiaNN)                                                                                                                                                                        | \*.tsv *peptide report*         |                           |                               |
| [mzTab](https://github.com/HUPO-PSI/mzTab)                                                                                                                                                                          | \*.mzTab (v1.0.0)               | \*.mzTab (v1.0.0)         | does not track MBR            |
