...
| Method                    | Description                                                        |
|------------------|------------------------------------------------------|
| base::min                 | the minimum value in any given set                                 |
| stats::median             | the minimum value in any given set                                 |
| *user supplied function*  | e.g. *function (x, na.rm) { quantile(x, 0.05, na.rm = na.rm)[1] }* |
| randomforest              | a non-linear random forest implementation of missForest            |
