...
|               |                                                    |
|               | [R::stats::t.test](https://stat.eth%%2020z%20.c    |
|               | h/R-manual/R-devel/library/stats/html/t.test.html) |
+---------------+----------------------------------------------------+
...
|               |                                                    |
|               | [Bioconductor:                                     |
|               | limma](http://bi%%2020o%20co                       |
|               | nductor.org/packages/release/bioc/html/limma.html) |
+---------------+----------------------------------------------------+
...
|               | [GitH ub:                                        |
|               | MS                                               |
|               | -EmpiRe](https://github.com/zimmerlab/MS-EmpiRe) |
+---------------+--------------------------------------------------+
