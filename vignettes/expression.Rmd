...
|              |                                                      |
|              | [R::stats::t.test](https://stat.eth%%2020z           |
...
|              | "DEqMS: A Method for Accurate Variance Estimation  |
|              | in Differential Protein Expression Analysis."      |
|              | *Molecular & Cellular Proteomics: MCP* 19 (6):     |
|              | 1047--57.                                          |
|              |                                                    |
|              | [Bioconductor:                                     |
|              | DEqMS](https://w%20ww.bi%20oco                     |
|              | nductor.org/packages/release/bioc/html/DEqMS.html) |
+--------------+----------------------------------------------------+
...
|              | Label-Free Quantification." *Molecular & Cellular  |
|              | Proteomics: MCP* 19 (7): 1209--19.                 |
|              |                                                    |
|              | [Bioconductor:                                     |
|              | msqrob2](https://www%20.bioc%20ond                 |
|              | uctor.org/packages/release/bioc/html/msqrob2.html) |
+--------------+----------------------------------------------------+
...
|              | displaying      |              |              |
+--------------+-----------------+--------------+--------------+
| signifi      | the column to   | -   a        | *a           |
| cance_column | use for         |              | dj_p\_value* |
|              | significance    | dj_p\_value, |              |
|              |                 |              |              |
|              |                 | p_value\*    |              |
+--------------+-----------------+--------------+--------------+
...
|              | cutoff lines    | FALSE*       |              |
+--------------+-----------------+--------------+--------------+
| s            | show the second | *TRUE /      | *TRUE*       |
| how_fc_scale | scale on top    | FALSE*       |              |
|              | converting      |              |              |
|              | *l              |              |              |
|              | og2_foldchange* |              |              |
|              | to *foldchange* |              |              |
