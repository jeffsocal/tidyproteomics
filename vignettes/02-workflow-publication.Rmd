...
rdata <- rdata %>%
  ...
  plot_volcano(ko/wt, destination = 'png', significance_column = 'p_value') %>% 
  plot_proportion(ko/wt, destination = 'png')
```
...
rdata <- rdata %>%
  ...
  enrichment(ko/wt, .term = 'cellular_component') %>%
  enrichment(ko/wt, .term = 'molecular_function') %>%
  # plot the enrichment analysis
  plot_enrichment(ko/wt, .term = 'biological_process', destination = 'png') %>%
  plot_enrichment(ko/wt, .term = 'cellular_component', destination = 'png') %>%
  plot_enrichment(ko/wt, .term = 'molecular_function', destination = 'png') 
```
