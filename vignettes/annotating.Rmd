...
data_prot <- "~/Local/gitdata/tidyproteomics_data/FragPipe_19.1/combined_protein.tsv" %>%
...
```{r, message=FALSE}
data_fasta <- "~/Local/fasta/uniprot_human-20398_20220920.fasta" %>% 
...
```{r 1001, echo=FALSE, fig.cap="\\label{fig:1001}UniProt web search for human proteins", out.width="82%", fig.align='center'}
knitr::include_graphics("../docs/images/uniprot_search_01.png")
```
...
```{r 1002, echo=FALSE, fig.cap="\\label{fig:1002}UniProt show table layout with Go annotations", out.width="82%", fig.align='center'}
knitr::include_graphics("../docs/images/uniprot_search_01.png")
```

Reda in the TSV file from the downloaded UniProt table.
```{r, message=FALSE}
data_go <- "~/Local/gitdata/uniprot-compressed_true_download_true_fields_accession_2Creviewed_2C-2023.04.13-22.27.47.76.tsv" %>% read_tsv()
